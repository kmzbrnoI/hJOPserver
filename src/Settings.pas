...
uses
  ...
  IdComponent, IdIPWatch, Main, CPort, CPortCtl, AC, THnaciVozidlo,
...
uses  Tester, Nastaveni_Casu,
  About, ACEdit, Verze,
  ZesilovacEdit,
  HVEdit, LoginPozadi, SystemInfo,
  BlkUsek, BlkVyhybka, BlkIR, BlkSCom, BlkNew, AdminForm,
  VCEdit, RychlostiEdit,
  Splash, GetSystems, Prevody,
   TechnologieJC, FileSystem, TBloky, TBlok,
  TBlokVyhybka, TBlokSCom, TBlokUsek, TBlokIR, TOblsRizeni, BoosterDb,
  SnadnSpusteni, TBlokPrejezd, BlkPrejezd, TJCDatabase, THVDatabase,
...
procedure TF_Options.StartLogWrite;
 begin
  ...
  WriteLog('$$$$$$$$$$ Spouštím Øídící program $$$$$$$$$$',WR_MESSAGE);
