...
uses
  ...
  Dialogs, StdCtrls, Spin, ExtCtrls, ComCtrls, Main, TBlokSCom, RpConst,
  BlkSComEvent, Generics.Collections, Themes, CloseTabSheet, Buttons,
  StrUtils;
...
uses GetSystems, FileSystem, TechnologieMTB, TBlok, TBloky,
      TBLokUsek, DataBloky, Settings, TBlokPrejezd;
