...
begin
 ...
 case (Self.clients[index].status) of
  TPanelConnectionStatus.closed    : F_Main.LV_Clients.Items[index].SubItems[0] := 'uzavřeno';
  ...
  TPanelConnectionStatus.opened    : F_Main.LV_Clients.Items[index].SubItems[0] := 'otevřeno';
 end;
