...
begin
  ...
  if (Boosters[Self.m_settings.boosterId] = nil) then
    writelog('WARNING: Blok ' + Self.name + ' (' + IntToStr(Self.id) + ') nemá návaznost na validní zesilovač',
      WR_ERROR);
  ...
  try
    ...
    begin
      try
        ...
        writelog('Nepodarilo se nacist houkaci udalost ' + Data + ' bloku ' + Self.name, WR_ERROR);
        Exit();
      end;
