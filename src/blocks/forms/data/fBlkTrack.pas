...
begin
  ...
  begin
    Self.SE_System0.Value := settings.RCSAddrs[0].system;
  ...
  begin
    Self.SE_System1.Value := settings.RCSAddrs[1].system;
  ...
  begin
    Self.SE_System2.Value := settings.RCSAddrs[2].system;
  ...
  begin
    Self.SE_System3.Value := settings.RCSAddrs[3].system;
