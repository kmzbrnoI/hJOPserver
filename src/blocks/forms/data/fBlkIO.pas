...
type
  TF_BlkIO = class(TForm)
    ...
    SE_RCS_Output_System: TSpinEdit;
    Label3: TLabel;
...
begin
  ...
  Self.SE_RCS_Input_System.Value := 0;
...
begin
  ...
  begin
    Self.SE_RCS_Input_System.Value := settings.RCSinput.system;
  ...
  begin
    Self.SE_RCS_Output_System.Value := settings.RCSOutput.system;
...
begin
  Self.SE_RCS_Input_System.MaxValue := RCSs._RCSS_MAX;
  Self.SE_RCS_Output_System.MaxValue := RCSs._RCSS_MAX;
...
begin
  ...
  Self.SE_RCS_Input_System.Enabled := Self.CHB_RCS_Input.Checked;
...
begin
  ...
  Self.SE_RCS_Output_System.Enabled := Self.CHB_RCS_Output.Checked;
...
begin
  ...
  begin
    var another := Blocks.AnotherBlockUsesRCS(TRCSs.RCSsAddr(Self.SE_RCS_Input_System.Value, Self.SE_RCS_Input_Module.Value, Self.SE_RCS_Input_Port.Value),
  ...
  begin
    var another := Blocks.AnotherBlockUsesRCS(TRCSs.RCSsAddr(Self.SE_RCS_Output_System.Value, Self.SE_RCS_Output_Module.Value, Self.SE_RCS_Output_Port.Value),
