  ...
  begin
    ...
    begin
      try
        ...
        PanelServer.BottomError(SenderPnl, 'Nepoda�ilo se aktivovat blok', TArea(SenderOR).shortName, 'TECHNOLOGIE');
      end
    end
    else
      PanelServer.Menu(SenderPnl, Self, (SenderOR as TArea), Self.ShowPanelMenu(SenderPnl, SenderOR, rights));
  ...
  begin
    ...
    begin
      try
        ...
        PanelServer.BottomError(SenderPnl, 'Nepoda�ilo se deaktivovat blok', TArea(SenderOR).shortName, 'TECHNOLOGIE');
      end
    end;
  end;
end;
...
begin
  try
    ...
    PanelServer.BottomError(SenderPnl, 'Simulace nepovolila nastaven� RCS vstup�!', TArea(SenderOR).shortName,
      'SIMULACE');
  end;
end;
