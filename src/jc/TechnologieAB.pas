...
begin
  ...
  Log('AB: JC ' + jc.name + ' přidána do seznamu AB JC', WR_VC);
end;
...
begin
  ...
  Log('AB: JC ' + Self.JCs[i].name + ' odstraněna ze seznamu AB JC', WR_VC);
  Self.JCs.Delete(i);
...
begin
  ...
  try
    ...
    Log('DN JC ' + jc.name + ' : podmínky splněny, stavím', WR_STACK);
