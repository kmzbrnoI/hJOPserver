...
uses
  ...
  Block in 'bloky\Block.pas',
  BlockTurnout in 'bloky\BlockTurnout.pas',
  BlockTrack in 'bloky\BlockTrack.pas',
  BlockIR in 'bloky\BlockIR.pas',
  BlockSignal in 'bloky\BlockSignal.pas',
  ...
  BlockRailway in 'bloky\BlockRailway.pas',
  BlockLinker in 'bloky\BlockLinker.pas',
  Train in 'Train.pas',
  ...
  BlockTrackRefs in 'bloky\BlockTrackRefs.pas',
