...
uses
  ...
  Dialogs, StdCtrls, ExtCtrls, Spin, ComCtrls, Main, Settings,
  BlkUsekSysVars, TBloky, TBlok, TBlokUsek, RPConst, Mask, StrUtils;
...
uses GetSystems, FileSystem, TechnologieMTB, BoosterDb, DataBloky;
